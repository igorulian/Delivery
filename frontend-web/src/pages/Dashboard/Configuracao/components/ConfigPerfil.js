    ...
    render(){ 
        return(
            ...
            {this.state.dados.imageUrl !== '' &&
                <>
                    <div style={{width: '100%', justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
                        <img alt="Imagem perfil" style={{width: '140px', height: '140px', marginBottom: '10px', opacity: this.state.isUploadingFile === false ? '100%' : '50%'}} src={this.state.dados.imageUrl}></img>
